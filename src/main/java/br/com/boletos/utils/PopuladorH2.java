...
public class PopuladorH2 implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        boletoRepository.save(new Boleto(null, "3dc5ce0b-bc05-4112-82a5-e8caa95243eb", new BigDecimal("200.00"), LocalDate.of(2024, 07, 10), "76059360000120", "Internet do Bairro", "Internet do bairro", SituacaoBoleto.EM_ABERTO));
        boletoRepository.save(new Boleto(null, "ad89ba0d-3193-4daa-875f-581657f3d875", new BigDecimal("200.00"), LocalDate.of(2024, 07, 10), "07617436777", "Marcos", "Marcos", SituacaoBoleto.EM_ABERTO));
