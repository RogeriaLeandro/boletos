...
public class BoletoController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "204", description = "Boleto já Pago Anteriormente"),
			@ApiResponse(responseCode = "203", description = "Boleto com Valor Divergente ao Cadastrado")})
